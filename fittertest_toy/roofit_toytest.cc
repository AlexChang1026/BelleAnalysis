...
void  roofit_toytest(int number) {
        ...
        psigmapi->Add("/home/belle/chuan/fittertest_gsim3/rareplambdapi_cs3.root");
        plambdapi->Add("/home/belle/chuan/fittertest_gsim3/plambdapi_cs_pure.root");
        bb->Add("/home/belle/chuan/fittertest_gsim3/bbplambdapix10_cs3.root");
        qq->Add("/home/belle/chuan/fittertest_gsim3/qqplambdapix6_cs3.root");
       ...
       // mbc0.setbins(100);
       // de.setbins(100);
       TH2D *hist = new TH2D("hist","",50,-0.3,0.2,100,5.23,5.30);
      ...
      //  mbc Pdf
        ...
        RooRealVar mbc_qq_c ("mbc_qq_c","mbc_qq_c",-3.67198e+01);
        
        RooArgusBG mbc_qq("mbc_qq","mbc_qq",mbc0,mbc_qq_m0,mbc_qq_c);
        
        //bb
        RooRealVar m0("m0","",5.28860e+00);
        RooRealVar k("k","",-4.14992e+01);
        RooRealVar p("p","",4.11323e-01);
    
        RooArgusBG mbc_bb("mbc_bb","",mbc0,m0,k,p);          


        //plambdapi
    
        RooRealVar mbc_plambda_sigma("mbc_plambda_sigma","mbc_plambda_sigma",2.58657e-03);
        RooRealVar mbc_plambda_mu("mbc_plambda_mu","mbc_plambda_mu",5.27949e+00);
        RooRealVar mbc_plambda_alpha("mbc_plambda_alpha","mbc_plambda_alpha",2.34068e+00);
        RooRealVar mbc_plambda_n("mbc_plambda_n","mbc_plambda_n",2.71086e+00);
        ...
        RooRealVar mbc_width("mbc_width","",1.43979e-02);
        RooRealVar mbc_width2("mbc_width2","",2.58140e-03);

        RooGaussian mbc_gaus("mbc_gaus","",mbc0,mbc_mean,mbc_width);
        RooGaussian mbc_gaus2("mbc_gaus2","",mbc0,mbc_mean,mbc_width2);

        RooRealVar mbc_frac3("mbc_frac3","",4.70617e-03);
    ...
    //---------------------de Pdf-----------------------------
        ...
        //qq
        RooRealVar de_qq_slope("de_qq_slope","",-1.19492e+00);
        RooPolynomial de_qq("de_qq","",de,RooArgSet(de_qq_slope));
   
        //bb 
        
         RooRealVar a0("a0","a0",-5.16088e-01) ;
         RooRealVar a1("a1","a1",1.02092e-01) ;
        ...
        RooRealVar de_mean("de_mean","de_mean",4.10093e-04);
        RooRealVar de_width1("de_width1","de_width1",2.35662e-02);
        RooRealVar de_width2("de_width2","de_width2",9.99882e-03);
        RooRealVar de_width3("de_width3","de_width3",8.66310e-02);
        ...
        RooRealVar de_frac("de_frac","",1.42889e-01);
        RooRealVar de_frac2("de_frac2","",2.22797e-02);
     ...
     for(int i = 0;i<10;i++)
  {
     //-----------------------Gsim part 1 -----------------------------  
        ...
        number_psigmapi_true = rnd -> PoissonD(90);
        number_plambdapi_true = rnd -> PoissonD(250);
        number_bb = rnd -> PoissonD(600);
        number_qq = rnd -> PoissonD(4400);
...
//-----------------------------------------------------------------------------
        ...
        if(nsig.getVal() < 90)
        {
           pull = (90-nsig.getVal())/nsig.getAsymErrorHi();
        }
        else
        {
           pull = (-90+nsig.getVal())/nsig.getAsymErrorLo();
  ...
  /* 
        ...
        RooPlot *plot_mbc_projection = mbc0.frame(Bins(50),Name("plot_mbc_projection"),Title("plot_mbc_projection"));
	...
	canvas->SaveAs("mbc_fit.eps");
        ...
        RooPlot *plot_de_projection = de.frame(Bins(50),Name("plot_de_projection"),Title("plot_de_projection"));
